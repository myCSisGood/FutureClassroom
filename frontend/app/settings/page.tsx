...
export default function SettingsPage() {
  return (
    <div className="p-8 flex flex-col gap-14 bg-[rgba(242,242,242,1)]">
      ...
      <div className="relative bg-white rounded-[2rem] h-[96px] flex items-center justify-between pr-8">
        <div className="flex items-center">
          <div className="absolute -left-2 top-1/2 -translate-y-1/2 w-[144px] h-[144px] rounded-full bg-[rgba(242,242,242,1)] p-1 overflow-hidden border-4 border-white">
        ...
        <button className="flex items-center gap-2 px-6 py-2 bg-red-50 text-red-500 rounded-full font-medium hover:bg-red-100 transition-colors cursor-pointer">
          <LogOut size={18} />
          <span>登出</span>
        </button>
      </div>
      <div className="bg-white rounded-[2rem] overflow-hidden">
        <div className="divide-y divide-slate-100">
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-white rounded-2xl">
                <Image
                  src="/icon/decoration/icon_language.svg"
                  alt="Language"
                  width={40}
                  height={40}
                />
            ...
            <button className="flex items-center gap-2 px-4 py-2 border border-slate-200 rounded-full text-slate-600 hover:bg-white cursor-pointer">
              依照瀏覽器
              <ChevronDown size={18} />
            </button>
          </div>
          ...
          <div className="p-4 flex items-center gap-4">
            <div className="p-3 bg-white rounded-2xl">
              <Image
                src="/icon/decoration/icon_document.svg"
          ...
          <div className="p-4 flex items-center gap-4">
            <div className="p-3 bg-white rounded-2xl">
              <Image
                src="/icon/decoration/icon_profile.svg"
                alt="Contact"
                width={40}
                height={40}
              />
          ...
          <div className="p-4 flex items-center gap-4">
            <div className="p-3 bg-white rounded-2xl">
              <Image
                src="/icon/decoration/icon_maintenance.svg"
                alt="Maintenance"
                width={40}
                height={40}
              />
